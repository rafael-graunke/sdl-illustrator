...
uint16_t iconeSelect[16]    = {0b0001100000000000, 0b0001010000000000, 0b0001001000000000, 0b0001000100000000, 0b0001000010000000, 0b0001000001000000, 0b0001000000100000, 0b0001000000010000, 0b0001000000001000, 0b0001000000000100, 0b0001000000000010, 0b0001000011111110, 0b0001000100000000, 0b0001001000000000, 0b0001010000000000, 0b0001100000000000}; // cursor
uint16_t iconeLine[16]      = {0b1100000000000000, 0b1110000000000000, 0b0111000000000000, 0b0011100000000000, 0b0001110000000000, 0b0000111000000000, 0b0000011100000000, 0b0000001110000000, 0b0000000111000000, 0b0000000011100000, 0b0000000001110000, 0b0000000000111000, 0b0000000000011100, 0b0000000000001110, 0b0000000000000111, 0b0000000000000011}; // diagonal
uint16_t iconeRectangle[16] = {0b0000000000000000, 0b0111111111111110, 0b0100000000000010, 0b0100000000000010, 0b0100000000000010, 0b0100000000000010, 0b0100000000000010, 0b0100000000000010, 0b0100000000000010, 0b0100000000000010, 0b0100000000000010, 0b0100000000000010, 0b0100000000000010, 0b0100000000000010, 0b0111111111111110, 0b0000000000000000}; // contorno
uint16_t iconePolygon[16]   = {0b0000000100000000, 0b0000000110000000, 0b0000001010000000, 0b0000001001000000, 0b0000010001000000, 0b0000010000100000, 0b0000100000100000, 0b0000100000010000, 0b0001000000010000, 0b0001000000001000, 0b0010000000001000, 0b0010000000000100, 0b0100000000000100, 0b0100000000000010, 0b1000000000000010, 0b1111111111111111}; // triangulo
uint16_t iconeCircle[16]    = {0b0000000000000000, 0b0000000010000000, 0b0000001101100000, 0b0000110000011000, 0b0001000000000100, 0b0001000000000100, 0b0010000000000010, 0b0010000000000010, 0b0100000000000001, 0b0010000000000010, 0b0010000000000010, 0b0001000000000100, 0b0001000000000100, 0b0000110000011000, 0b0000001101100000, 0b0000000010000000}; // circulo
uint16_t iconeBezier[16]    = {0b0000000000000000, 0b0111110000000000, 0b0000011000000000, 0b0000001100000000, 0b0000000100000000, 0b0000000100000000, 0b0000000100000000, 0b0000000100000000, 0b0000000010000000, 0b0000000010000000, 0b0000000010000000, 0b0000000010000000, 0b0000000011000000, 0b0000000001100000, 0b0000000000111110, 0b0000000000000000}; // curva
uint16_t iconeFill[16]      = {0b0011111000000000, 0b0111111100000000, 0b0100000010000000, 0b0100000001000000, 0b0100000000100000, 0b0100000000010000, 0b0100000000001000, 0b0111111111110000, 0b0000001111000000, 0b0000000110000000, 0b0000000110000000, 0b0000001111000000, 0b0000000110000000, 0b0000000000000000, 0b0000000000000000, 0b0000000000000000}; // balde
...
void drawGlyph(Line &l, ToolType tool, int originX, int originY, int scale, int r, int g, int b)
{
    ...
    for (int row = 0; row < 16; row++)
    {
        ...
        {
            // testa o bit da coluna (8 bits, do mais significativo pro menos significativo)
            int bit = (icone[row] >> (15 - col)) & 1;
            if (bit == 0)
                continue;
...
void drawToolbox()
{
    ...
    for (ToolboxItem item : toolboxItems)
    {
        ...
        drawGlyph(l, item.tool, gx, gy, scale, 20, 20, 20);
    }
}
